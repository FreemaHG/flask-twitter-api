...
class TestTweets:
    ...
    def test_create_tweet(self, client, tweets,
                          new_tweet, headers_with_content_type, resp_for_new_tweet) -> None:
        """
    ...
    def test_create_tweet_with_images(self, client, tweets, headers_with_content_type,
                          new_tweet_with_image, resp_for_new_tweet) -> None:
        """
        Тестирование добавления твита с изображениями
        """
        resp = self.send_request(client=client, headers=headers_with_content_type, new_tweet_data=new_tweet_with_image)
        assert resp
        assert resp.status_code == HTTPStatus.CREATED
        assert resp.json == resp_for_new_tweet


    def test_create_invalid_tweet(self, client, tweets, headers_with_content_type,
                          new_tweet, resp_for_new_tweet, bad_response) -> None:
        """
    ...
    def test_delete_tweet_not_found(self, client, tweets, headers, response_tweet_not_found) -> None:
        """
    ...
    def test_delete_tweet_locked(self, client, tweets, headers, response_tweet_locked) -> None:
        """
